...
{
	static const auto funcName = "vvm.mul.i256";
...
{
	static const auto funcName = "vvm.mul.i512";
	if (auto func = _module.getFunction(funcName))
		return func;
...
{
	static const auto funcName = "vvm.udivrem.i256";
	if (auto func = _module.getFunction(funcName))
		return func;
...
{
	static const auto funcName = "vvm.udivrem.i512";
	if (auto func = _module.getFunction(funcName))
		return func;
...
{
	static const auto funcName = "vvm.udiv.i256";
	if (auto func = _module.getFunction(funcName))
		return func;
...
{
	static const auto funcName = "vvm.urem.i256";
	if (auto func = _module.getFunction(funcName))
		return func;
...
{
	static const auto funcName = "vvm.urem.i512";
	if (auto func = _module.getFunction(funcName))
		return func;
...
{
	static const auto funcName = "vvm.sdivrem.i256";
	if (auto func = _module.getFunction(funcName))
		return func;
...
{
	static const auto funcName = "vvm.sdiv.i256";
	if (auto func = _module.getFunction(funcName))
		return func;
...
{
	static const auto funcName = "vvm.srem.i256";
	if (auto func = _module.getFunction(funcName))
		return func;
...
extern "C"
{
	VVMJIT_API void debug(uint64_t a, uint64_t b, uint64_t c, uint64_t d, char z)
	{
