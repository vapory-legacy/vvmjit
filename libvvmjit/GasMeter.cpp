...
GasMeter::GasMeter(IRBuilder& _builder, RuntimeManager& _runtimeManager, vvm_revision rev):
...
void GasMeter::countExp(llvm::Value* _exponent)
{
	...
	auto exponentByteCost = m_rev >= VVM_SPURIOUS_DRAGON ? 50 : JITSchedule::expByteGas::value;
...
int64_t GasMeter::getStepCost(Instruction inst) const
{
	...
	case Instruction::BALANCE:
		return m_rev >= VVM_TANGERINE_WHISTLE ? 400 : JITSchedule::stepGas6::value;

	case Instruction::EXTCODESIZE:
	case Instruction::EXTCODECOPY:
		return m_rev >= VVM_TANGERINE_WHISTLE ? 700 : JITSchedule::stepGas6::value;

	case Instruction::BLOCKHASH:
		return m_rev >= VVM_CONSTANTINOPLE ? 800 : JITSchedule::stepGas6::value;

	case Instruction::SHA3:
		return JITSchedule::sha3Gas::value;

	case Instruction::SLOAD:
		return m_rev >= VVM_TANGERINE_WHISTLE ? 200 : JITSchedule::sloadGas::value;
	...
	case Instruction::STATICCALL:
		return m_rev >= VVM_TANGERINE_WHISTLE ? 700 : JITSchedule::callGas::value;

	case Instruction::CREATE:
		return JITSchedule::createGas::value;

	case Instruction::SUICIDE:
		return m_rev >= VVM_TANGERINE_WHISTLE ? 5000 : JITSchedule::stepGas0::value;
