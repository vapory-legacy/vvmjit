...
class LowerVVMPass: public llvm::BasicBlockPass
{
	static char ID;
...
char LowerVVMPass::ID = 0;

bool LowerVVMPass::runOnBasicBlock(llvm::BasicBlock& _bb)
{
	auto modified = false;
...
bool LowerVVMPass::doFinalization(llvm::Module&)
{
	return false;
}
