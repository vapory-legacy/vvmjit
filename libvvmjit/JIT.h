...
public:
	...
	ExecutionContext(RuntimeData& _data, vvm_context* _ctx) { init(_data, _ctx); }
	ExecutionContext(ExecutionContext const&) = delete;
	ExecutionContext& operator=(ExecutionContext const&) = delete;
	~ExecutionContext() noexcept;

	void init(RuntimeData& _data, vvm_context* _ctx) { m_data = &_data; m_ctx = _ctx; }
...
public:
	...
	vvm_context* m_ctx = nullptr;	///< Pointer to Host execution context. Expected by compiled contract.
