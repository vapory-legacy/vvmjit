...
/// The flag indicating call failure in vvm_call_fn() -- highest bit set.
constexpr int64_t VVM_CALL_FAILURE = 0x8000000000000000;

/// The hackish constant indicating VVM_CALL + VVM_STATIC flag.
constexpr int VVM_STATICCALL = VVM_CREATE + 1;
